...
$lang_module['report_sendmail_title'] = 'Cảm ơn bạn đã báo lỗi';
$lang_module['report_sendmail_content'] = 'Xin chào!<br />Ban quản trị website %s cảm ơn bạn đã gửi đến chúng tôi báo cáo lỗi trong nội dung bài viết. Lỗi mà bạn thông báo đã được chúng tôi sửa lại.<br />Hy vọng sẽ nhận được sự giúp đỡ tiếp theo của bạn trong tương lai.<br />Chúc bạn luôn mạnh khỏe, hạnh phúc và thành công!';
...
$lang_module['auto_nav_note'] = 'Để tạo mục lục bài viết, bạn cần sử dụng các html-tags <code>h2</code> và <code>h3</code> trong phần Nội dung chi tiết. Tag <code>h2</code> sẽ được chọn là mục chính. Tag <code>h3</code> phải đặt trong tag <code>h2</code> và sẽ được chọn là mục con.';
...
$lang_module['admin_topic_sl'] = 'Chọn nhóm tin liên quan hoặc tự điền';
