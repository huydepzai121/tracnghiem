...
$lang_module['main_title'] = 'Mes API';
...
$lang_module['auth_method_none'] = 'Aucun';
...
$lang_module['saveopt1'] = 'Enregistrer les modifications pour la %s';
$lang_module['saveopt2'] = 'Enregistrer les modifications pour toutes les langues';
$lang_module['saveopt3'] = 'Enregistrez les modifications pour le %s et accédez à la configuration pour le %s';
