...
$lang_module['account_active_info'] = '%1$s<br /><br />Votre compte sur le site Web %2$s attend d\'être activé. Pour l\'activer, veuillez cliquer sur le lien suivant:<br /><br />URL: <a href="%3$s">%3$s</a><br /><br />Informations sur le compte:<br /><br />Nom d\'utilisateur: %4$s<br />E-mail: %5$s<br /><br />Activation expirée le %6$s<br /><br />Ceci est un envoi automatique d\'e-mail du site Web %2$s.';
...
$lang_module['delconfirm_email_content'] = '%1$s<br /><br />Nous sommes désolé de vous informer la suppression de votre compte sur le site %2$s.';
...
$lang_module['verify_email_mess'] = 'Bonjour!<br /><br />Vous avez envoyé une demande de vérification de votre adresse e-mail: %s. Copiez le code ci-dessous et collez-le dans la case Code de vérification sur le site.<br /><br />Code de vérification: <span>%s</span><br /><br />Ceci est un e-mail envoyé automatiquement depuis site Web %s.';
...
$lang_module['security_alert_openid_add'] = 'Nous vous informons qu\'un compte tiers <strong>%s</strong> vient d\'être connecté à votre compte <strong>%s</strong> par le chef d\'équipe.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Gérer les comptes tiers</a>';
$lang_module['security_alert_openid_add1'] = 'Le compte tiers <strong>%s</strong> vient d\'être connecté à votre compte <strong>%s</strong>. Si ce n\'était pas votre intention, veuillez le supprimer rapidement de votre compte en vous rendant dans la zone de gestion des comptes tiers.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Gérer les comptes tiers</a>';
$lang_module['security_alert_openid_delete'] = 'Nous vous informons que le compte tiers <strong>%s</strong> vient d\'être déconnecté de votre compte <strong>%s</strong> par le chef d\'équipe.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Gérer les comptes tiers</a>';
$lang_module['security_alert_openid_delete1'] = 'Le compte tiers <strong>%s</strong> vient d\'être déconnecté de votre compte <strong>%s</strong>. Si ce n\'est pas votre intention, veuillez contacter rapidement l\'administrateur du site pour obtenir de l\'aide.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Gérer les comptes tiers</a>';
...
$lang_module['adduser_register_info_with_password'] = '%1$s<br /><br /> Votre compte sur le site Web %2$s est activé. Les informations de connexion est au dessous:<br /><br />URL: <a href="%3$s">%3$s</a><br />Nom de compte: %4$s<br />Mot de passe: %5$s<br /><br />Cela est un message automatique qui était envoyé à votre boîte mail à partir du site %2$s. Si vous ne comprenez pas le contenu de ce mail, vous pouvez simplement le supprimer.';
$lang_module['adduser_register_openid_info'] = '%1$s<br /><br />Votre compte sur le site Web %2$s est activé.<br />Pour vous connecter à votre compte, veuillez visiter la page: <a href="%3$s">%3$s</a> et appuyez sur le bouton: Connectez-vous avec %4$s.<br /><br />Cela est un message automatique qui était envoyé à votre boîte mail à partir du site %2$s. Si vous ne comprenez pas le contenu de ce mail, vous pouvez simplement le supprimer.';
$lang_module['adduser_register_openid_info_with_password'] = '%1$s<br /><br />Votre compte sur le site Web %2$s est activé.<br />Pour vous connecter à votre compte, veuillez visiter la page: <a href="%3$s">%3$s</a> et appuyez sur le bouton: Connectez-vous avec %4$s.<br />Vous pouvez également vous connecter en utilisant la méthode habituelle avec les informations suivantes:<br />Nom de compte: %5$s<br />Mot de passe: %6$s<br /><br />Cela est un message automatique qui était envoyé à votre boîte mail à partir du site %2$s. Si vous ne comprenez pas le contenu de ce mail, vous pouvez simplement le supprimer.';
$lang_module['adduser_register_info1'] = '%1$s<br /><br /> Votre compte sur le site %2$s a été créé. Voici vos informations de connexion: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Nom: %4$s<br /> mot de passe: %5$s<br />%6$s<br /> Ceci est un message automatique envoyé. votre boîte de réception e-mail à partir du site web %2$s. Si vous ne comprenez rien au sujet du contenu de cette lettre, supprimer tout simplement.';
$lang_module['adduser_register_info2'] = '%1$s<br /><br /> Votre compte sur le site %2$s a été mis à jour. Voici les informations de connexion: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Nom: %4$s';
$lang_module['adduser_register_info3'] = '<br /> Mot de passe: %1$s';
$lang_module['adduser_register_info4'] = '<br />%1$s<br />Ceci est un message automatique envoyé à votre boîte de réception e-mail à partir du site %2$s. Si vous ne comprenez rien au sujet du contenu de cette lettre, supprimer tout simplement.';
$lang_module['pass_reset_request_subject1'] = 'Besoin de changer le mot de passe du compte';
$lang_module['pass_reset_request_subject2'] = 'Changement de mot de passe de compte recommandé';
$lang_module['pass_reset_request_info1'] = '%1$s<br /><br />L\'administration du site %2$s informe: Pour des raisons de sécurité, vous devez changer le mot de passe de votre compte dès que possible. Pour modifier votre mot de passe, vous devez d\'abord vous rendre sur la page Gestion du compte personnel (%3$s), sélectionner le bouton Paramètres du compte, puis le bouton Mot de passe, et suivre les instructions.';
$lang_module['pass_reset_request_info2'] = '%1$s<br /><br />L\'administration du site %2$s informe: Pour des raisons de sécurité, nous vous recommandons de modifier le mot de passe de votre compte. Pour modifier votre mot de passe, vous devez d\'abord vous rendre sur la page Gestion du compte personnel (%3$s), sélectionner le bouton Paramètres du compte, puis le bouton Mot de passe, et suivre les instructions.';
...
$lang_module['pass_reset_request1_info'] = '<br />Remarque: Vous devez changer votre mot de passe avant d\'utiliser votre compte.<br />';
$lang_module['pass_reset_request2_info'] = '<br />Remarque: Nous vous recommandons de changer votre mot de passe avant d\'utiliser votre compte.<br />';
...
$lang_module['admin_security_alert_openid_delete'] = 'Nous vous informons que le compte tiers <strong>%s</strong> vient d\'être déconnecté de votre compte <strong>%s</strong> par un administrateur.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Gérer les comptes tiers</a>';
$lang_module['admin_forcedrelogin_note'] = 'L\'utilisateur s\'est déconnecté';
$lang_module['remove_2step_method'] = 'Autoriser les utilisateurs à désactiver automatiquement la vérification en 2 étapes lorsqu\'ils signalent la perte de leur téléphone (envoie un code de vérification par e-mail lorsque l\'utilisateur peut se connecter avec un mot de passe ou un compte tiers et répond à la bonne question de sécurité)';
...
$lang_module['remove_2step_verifykey_subject'] = 'Informations sur la désactivation de la vérification en deux étapes';
$lang_module['remove_2step_verifykey_content'] = '%1$s<br /><br />Nous avons reçu une demande de suppression de la vérification en deux étapes pour votre compte sur le site Web %2$s. Si vous avez envoyé cette demande vous-même, veuillez utiliser le code de vérification ci-dessous pour procéder à la suppression:<br /><br />Code de vérification: %3$s<br /><br />Il s\'agit d\'un envoi automatique d\'e-mail depuis le site Web %2$s.';
$lang_module['remove_2step_subject'] = 'La vérification en deux étapes est désactivée';
$lang_module['remove_2step_content'] = '%1$s<br /><br />À votre demande, nous avons désactivé la vérification en deux étapes pour votre compte sur le site Web %2$s.<br /><br />Il s\'agit d\'un envoi automatique d\'e-mail depuis le site Web %2$s.';
