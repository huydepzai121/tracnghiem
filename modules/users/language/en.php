...
$lang_module['lostactive_active_info'] = '%1$s<br /><br />Your account at website %2$s waitting to activate. To activate, please click link follow:<br /><br />URL: <a href="%3$s">%3$s</a><br /><br />Account information:<br /><br />Account: %4$s<br />Email: %5$s<br />Password: %6$s<br /><br />Activate expired on %7$s<br /><br />This is email automatic sending from website %2$s.';
...
$lang_module['email_active_info'] = '%1$s<br /><br />You sent a request to change the email address of the personal Account on the website %2$s. To complete this change, you must confirm your new email address by entering the verifykey below in the appropriate fields in the area Edit Account Information:<br /><br />Verifykey: <strong>%3$s</strong><br /><br />This key expires on %4$s.<br /><br />These are automatic messages sent to your e-mail inbox from website %2$s. If you do not understand anything about the contents of this letter, simply delete it.';
...
$lang_module['safe_send_content'] = '%1$s<br /><br />You sent a request using safe mode in website %2$s. Below is a verifykey  for activating or off safe mode:<br /><br /><strong>%3$s</strong><br /><br />This verifykey only works on-off safe mode once only. After you turn off safe mode, this verification code will be worthless.<br /><br />These are automatic messages sent to your e-mail inbox from website %2$s.';
...
$lang_module['delconfirm_email_content'] = '%1$s<br />We are so sorry to delete your account at website %2$s.';
...
$lang_module['verify_email_mess'] = 'Hello!<br /><br />You have sent a request to verify your email address: %s. Copy the code below and paste it into the Verification code box on the site.<br /><br />Verification code: <span>%s</span><br /><br />This is email automatic sending from website %s.';
...
$lang_module['security_alert_openid_add'] = 'We are informing you that a third party account <strong>%s</strong> has just been connected to your <strong>%s</strong> account by the group leader.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
$lang_module['security_alert_openid_add1'] = 'The third party account <strong>%s</strong> has just been connected to your <strong>%s</strong> account. If this was not your intention, please quickly remove it from your account by visiting the third party account management area.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
$lang_module['security_alert_openid_delete'] = 'We are informing you that the third party account <strong>%s</strong> has just been disconnected from your <strong>%s</strong> account by the group leader.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
$lang_module['security_alert_openid_delete1'] = 'The third-party account <strong>%s</strong> has just been disconnected from your <strong>%s</strong> account. If this is not your intention, please quickly contact the site administrator for help.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
...
$lang_module['adduser_register_info_with_password'] = '%1$s<br />Your account at website %2$s activated. Your login information:<br />URL: <a href="%3$s">%3$s</a><br />Username: %4$s<br />Password: %5$s<br /><br />This is email automatic sending from website %2$s.';
$lang_module['adduser_register_openid_info'] = '%1$s<br /><br />Your account at website %2$s activated.<br />To log into your account please visit the page: <a href="%3$s">%3$s</a> and press the button: Sign in with %4$s.<br /><br />This is email automatic sending from website %2$s.';
$lang_module['adduser_register_openid_info_with_password'] = '%1$s<br /><br />Your account at website %2$s activated.<br />To log into your account please visit the page: <a href="%3$s">%3$s</a> and press the button: Sign in with %4$s.<br />You can also log in using the usual method with the following information:<br />Username: %5$s<br />Password: %6$s<br /><br />This is email automatic sending from website %2$s.';
$lang_module['adduser_register_info1'] = '%1$s<br /><br /> Your account at website %2$s has been created. Here are the logins: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Username: %4$s<br /> < Password: %5$s<br />%6$s<br />This is an automated message sent to Your email box from %2$s. website. If you do not understand the content of this letter, simply delete it.';
$lang_module['adduser_register_info2'] = '%1$s<br /><br /> Your account at website %2$s has been updated. Here are the login information: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Username: %4$s';
$lang_module['adduser_register_info3'] = '<br /> Password: %1$s';
$lang_module['adduser_register_info4'] = '<br />%1$s<br />This is an automated message sent to your email from %2$s. If you do not understand the content of this letter, simply delete it.';
$lang_module['pass_reset_request_subject1'] = 'Need to change account password';
$lang_module['pass_reset_request_subject2'] = 'Recommended account password change';
$lang_module['pass_reset_request_info1'] = '%1$s<br /><br />The %2$s website administration informs: For security reasons, you need to change your account password as soon as possible. To change your password, you need to first visit the Manage Personal Account page (%3$s), select the Account Settings button, then the Password button, and follow the instructions.';
$lang_module['pass_reset_request_info2'] = '%1$s<br /><br />The %2$s website administration informs: For security reasons, we recommend that you change your account password. To change your password, you need to first visit the Manage Personal Account page (%3$s), select the Account Settings button, then the Password button, and follow the instructions.';
...
$lang_module['pass_reset_request1_info'] = '<br />Note: You need to change your password before using your account.<br />';
$lang_module['pass_reset_request2_info'] = '<br />Note: We recommend that you change your password before using your account.<br />';
...
$lang_module['user_2step_bodymail'] = '%1$s<br /><br /> backup code to your account at the website %2$s has been changed. Here is a new backup code: <br /><br />%3$s<br /><br /> You keep your backup safe. If you lose your phone and lose your backup code, you will no longer be able to access your account. <br /><br /> This is an automated message sent to your e-mail from website %2$s. If you do not understand the content of this letter, simply delete it.';
...
$lang_module['security_alert_openid_truncate'] = 'We inform you that all third party accounts have been disconnected from your <strong>%s</strong> account by an administrator.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
$lang_module['security_alert_2stepoff'] = 'Your <strong>%s</strong> account has just had two-step authentication disabled by your administrator. We send you this email to inform you.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Manage two-step authentication</a>';
...
$lang_module['admin_adduser_register_info'] = '%1$s<br /><br />Your account at website %2$s activated. Your login information:<br /><br />URL: <a href="%3$s">%3$s</a><br />Username: %4$s<br /><br />This is email automatic sending from website %2$s.';
...
$lang_module['admin_security_alert_openid_delete'] = 'We are informing you that the third party account <strong>%s</strong> has just been disconnected from your <strong>%s</strong> account by an administrator. We send you this email to inform you.<br /><br /><a href="%s" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px">Third-party accounts Management</a>';
$lang_module['admin_forcedrelogin_note'] = 'User has logged out';
$lang_module['remove_2step_method'] = 'Allows users to automatically turn off 2-step verification when they report their phone lost (Sends a Verification Code to email when the user is able to log in with a password or third-party account and answers the correct security question)';
...
$lang_module['remove_2step_verifykey_subject'] = 'Information about turning off 2-step verification';
$lang_module['remove_2step_verifykey_content'] = '%1$s<br /><br />We have received a request to turn off 2-step verification for your account at the %2$s website. If you sent this request yourself, please use the Verification Code below to proceed:<br /><br />Verification Code: %3$s<br /><br />This is email automatic sending from website %2$s.';
$lang_module['remove_2step_subject'] = '2-Step Verification is turned off';
$lang_module['remove_2step_content'] = '%1$s<br /><br />At your request, we have turned off 2-Step Verification for your account at the %2$s website.<br /><br />This is email automatic sending from website %2$s.';
