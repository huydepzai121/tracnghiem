...
$lang_module['description_error'] = 'Lỗi: Mô tả site chưa được khai báo';
$lang_module['rewrite'] = 'Bật chức năng rewrite tại khu vực người dùng';
$lang_module['rewrite_admin'] = 'Bật chức năng rewrite tại khu vực quản trị';
$lang_module['rewrite_optional'] = 'Loại bỏ biến ngôn ngữ khỏi URL';
$lang_module['rewrite_op_mod'] = 'Loại bỏ khỏi URL tên của module';
...
$lang_module['max_requests_60'] = 'Số request tối đa trong 1 phút';
$lang_module['max_requests_300'] = 'Số request tối đa trong 5 phút';
$lang_module['max_requests_error'] = 'Lỗi: Cần nhập số request lớn hơn 0';
$lang_module['nv_anti_iframe'] = 'Chống IFRAME';
$lang_module['nv_anti_agent'] = 'Chặn truy vấn nếu User-Agent không được xác định';
$lang_module['nv_allowed_html_tags'] = 'Các thẻ HTML được chấp nhận sử dụng';
$lang_module['nv_debug'] = 'Chế độ nhà phát triển';
$lang_module['nv_debug_help'] = 'Chế độ hiển thị lỗi trực quan được <strong>khuyến nghị bật</strong> trong quá trình lập trình và <strong>khuyến nghị tắt</strong> khi website chạy trong môi trường mạng công cộng.';
$lang_module['domains_restrict'] = 'Giới hạn tên miền ở các thẻ HTML nguy hiểm như iframe, object, embed...';
$lang_module['domains_whitelist'] = 'Tên miền tin cậy';
$lang_module['domains_whitelist_note'] = 'Mỗi tên miền một dòng. Nếu kích hoạt giới hạn tên miền ở mục bên trên, hệ thống sẽ chỉ cho phép sử dụng tài nguyên, liên kết từ các tên miền này';
...
$lang_module['recaptcha_type'] = 'Kiểu reCaptcha';
$lang_module['recaptcha_type_note'] = 'Chỉ áp dụng phiên bản 2';
...
$lang_module['mail_force_sender'] = 'Cố định người gửi';
$lang_module['mail_force_sender_note'] = 'Dùng để ép tất cả thông tin người gửi có giá trị theo cấu hình tại đây thay vì thông tin trong mỗi lần gửi';
$lang_module['mail_force_reply'] = 'Cố định người nhận phản hồi';
...
$lang_module['username_empty'] = 'Vui lòng khai báo Username';
$lang_module['password'] = 'Password';
$lang_module['password_empty'] = 'Vui lòng khai báo Password';
$lang_module['ftp_path'] = 'Remote path';
$lang_module['mail_config'] = 'Lựa chọn phương thức gửi mail';
...
$lang_module['incoming_ssl'] = 'Loại bảo mật';
$lang_module['verify_peer_ssl'] = 'Kiểm tra chứng chỉ máy chủ gửi yêu cầu (verify_peer)';
$lang_module['verify_peer_ssl_yes'] = 'Có';
$lang_module['verify_peer_ssl_no'] = 'Không';
$lang_module['verify_peer_name_ssl'] = 'Kiểm tra tên máy chủ gửi yêu cầu (verify_peer_name)';
$lang_module['outgoing'] = 'Máy chủ SMTP gửi mail';
$lang_module['outgoing_error'] = 'Lỗi: Bạn chưa khai báo Máy chủ SMTP gửi mail';
$lang_module['outgoing_port'] = 'Cổng gửi mail';
$lang_module['outgoing_port_error'] = 'Lỗi: bạn chưa khai báo cổng gửi mail';
$lang_module['smtp_username'] = 'Tài khoản gửi mail';
$lang_module['smtp_login'] = 'Bí danh';
$lang_module['smtp_login_error'] = 'Lỗi: bạn chưa khai báo bí danh';
$lang_module['smtp_pass'] = 'Mật khẩu';
$lang_module['smtp_pass_error'] = 'Lỗi: bạn chưa khai báo mật khẩu';
$lang_module['smtp_error_openssl'] = 'Lỗi: Máy chủ của bạn không hỗ trợ gửi mail qua ssl';
$lang_module['smtp_test'] = 'Lưu và gửi mail thử nghiệm';
...
$lang_module['blank_operation'] = 'Xử lý HTML đầu ra';
$lang_module['blank_operation_help'] = 'Bật tùy chọn này hệ thống tự động xử lý tối ưu một số vấn đề như dọn dẹp các dòng trống thừa, các khoảng trống thừa trước khi gửi cho trình duyệt người dùng';
...
$lang_module['str_referer_blocker'] = 'Chuyển hướng đến trang chủ các truy vấn có REFERER bên ngoài';
$lang_module['my_domains'] = 'Các domain của site';
$lang_module['searchEngineUniqueID'] = 'Google search Engine ID';
$lang_module['searchEngineUniqueID_note'] = 'Có định dạng kiểu như 000329275761967753447:sr7yxqgv294, <a href="https://nukeviet.vn/vi/faq/Su-dung-Google-Custom-Search-tren-NukeViet/" target="_blank">xem chi tiết</a>';
...
$lang_module['live_session_time0'] = '0 = session sẽ tồn tại đến khi đóng trình duyệt';
...
$lang_module['end_time_error'] = 'Thời gian kết thúc không thể nhỏ hơn thời gian bắt đầu';
$lang_module['ip_address'] = 'Địa chỉ IP';
$lang_module['notice'] = 'Ghi chú';
$lang_module['banip_area'] = 'Khu vực';
$lang_module['unlimited'] = 'Vô thời hạn';
$lang_module['area_select'] = 'Hãy chọn khu vực';
$lang_module['area_front'] = 'Ngoài site';
$lang_module['area_admin'] = 'Khu vực admin';
$lang_module['area_both'] = 'Cả admin và ngoài site';
$lang_module['ip_delete'] = 'Xóa';
$lang_module['ip_delete_confirm'] = 'Bạn có chắc muốn xóa ip này?';
$lang_module['ip_mask'] = 'Mask IP';
$lang_module['ip_not_entered'] = 'Hãy nhập địa chỉ IP';
$lang_module['area_not_selected'] = 'Hãy chọn khu vực';
$lang_module['ip_incorrect'] = 'IP không chính xác';
$lang_module['ip_write_error'] = 'Lỗi: hệ thống không thể ghi file. Hãy CHMOD thư mục %1$s ở chế độ 0777 hoặc "Change permission" để hệ thống có thể ghi file. Bạn cũng có thể tự tạo file %2$s với nội dung bên dưới và đặt vào thư mục %1$s';
...
$lang_module['cron_launcher_interval'] = 'Lặp lại';
$lang_module['cron_launcher_interval1'] = 'Thời gian lặp lại việc kiểm tra và thực thi công việc';
$lang_module['cron_launcher'] = 'Trình xử lý';
$lang_module['cron_launcher_system'] = 'Công cụ của hệ thống';
$lang_module['cron_launcher_server'] = 'Dịch vụ cron phía máy chủ';
$lang_module['cron_launcher_server_help'] = 'Thực thi thông qua URL';
...
$lang_module['closed_site'] = 'Thay đổi';
$lang_module['closed_site_0'] = 'Site hoạt động bình thường';
$lang_module['closed_site_1'] = 'Site đóng cửa cho tất cả, ngoại trừ Quản trị tối cao';
$lang_module['closed_site_2'] = 'Site đóng cửa cho tất cả, ngoại trừ Điều hành chung';
$lang_module['closed_site_3'] = 'Site đóng cửa cho tất cả, ngoại trừ Quản trị viên';
$lang_module['closed_site_reopening_time'] = 'Thời gian dự kiến mở lại';
$lang_module['ssl_https'] = 'Chuyển hướng từ HTTP sang HTTPS';
...
$lang_module['note_ssl'] = 'Tính năng này chỉ được bật khi website hỗ trợ giao thức HTTPS. Nếu không, website sẽ không thể truy cập. Bạn chắc chắn website hỗ trợ giao thức HTTPS?';
...
$lang_module['smime_self_declare'] = 'Hoặc tự khai báo nội dung chứng chỉ';
$lang_module['smime_certificate_content'] = 'Chứng chỉ';
$lang_module['smime_private_key'] = 'Khóa riêng';
$lang_module['smime_chain_certificates'] = 'Chuỗi chứng chỉ gốc';
$lang_module['smime_chain_certificates_note'] = 'Là các chứng chỉ gốc của cơ quan chứng nhận (CA)';
...
$lang_module['smime_private_key_cannot_be_read'] = 'Lỗi: Không thể đọc Khóa riêng của chứng chỉ';
$lang_module['DKIM_signature'] = 'Chữ ký số của miền gửi thư DKIM';
$lang_module['DKIM_note'] = 'Chữ ký số DKIM sẽ được gửi cùng với thư nếu nó được chứng thực và lưu trữ trên máy chủ.';
$lang_module['DKIM_verified'] = 'Chữ ký số DKIM đã được chứng thực';
$lang_module['DKIM_successfully_verified'] = 'Chữ ký số DKIM đã được chứng thực thành công';
$lang_module['DKIM_unverified'] = 'Chữ ký số DKIM chưa được chứng thực';
$lang_module['DKIM_TXT_host'] = 'Tên của bản ghi TXT';
$lang_module['DKIM_TXT_value'] = 'Giá trị của bản ghi TXT';
$lang_module['dkim_verify'] = 'Chứng thực';
$lang_module['dkim_reverify'] = 'Chứng thực lại';
$lang_module['dkim_del'] = 'Xóa';
$lang_module['dkim_del_confirm'] = 'Bạn thực sự muốn xóa chữ ký số này?';
$lang_module['DKIM_verify_note'] = 'Để chứng thực chữ ký số DKIM, hãy truy cập vào trang quản lý DNS của tên miền %s, thêm bản ghi TXT với các thông số dưới đây, sau đó click vào nút Chứng thực (Bạn có thể phải chờ để bản ghi mới cập nhật).';
...
$lang_module['DKIM_private_key_error'] = 'Không thể tạo khóa bí mật cho DKIM, hãy kiểm tra lại thiết lập OpenSSL trên máy chủ';
...
$lang_module['DKIM_empty'] = 'Chưa có chữ ký số DKIM nào được tạo';
$lang_module['dkim_included'] = 'Gửi kèm chữ ký số DKIM (nếu có) khi dùng';
$lang_module['smime_included'] = 'Gửi kèm chứng chỉ S/MIME (nếu có) khi dùng';
...
$lang_module['csp_source_hosts'] = 'Danh sách các máy chủ nguồn được chấp nhận';
$lang_module['csp_source_hosts_help'] = 'Mỗi giá trị một dòng';
...
$lang_module['sample_tab'] = 'Tệp cấu hình máy chủ mẫu';
...
$lang_module['search_settings'] = 'Các thiết lập tìm kiếm';
$lang_module['acp_settings'] = 'Các thiết lập dành cho khu vực admin';
$lang_module['waiting'] = 'Đang chờ';
$lang_module['running'] = 'Đang chạy';
$lang_module['ended'] = 'Đã kết thúc';
$lang_module['submitting_data_warning'] = 'Cảnh báo người dùng khi gửi dữ liệu';
$lang_module['submitting_data_warning_note'] = 'Nếu quốc gia của bạn bắt buộc phải cảnh báo cho người dùng trước khi gửi dữ liệu về việc cấp phép quyền sử dụng dữ liệu cá nhân hoặc/và luật chống tin rác, hãy tích vào các tùy chọn dưới đây';
$lang_module['data_usage_permission_warning'] = 'Hiển thị cảnh báo về việc cấp phép quyền sử dụng dữ liệu cá nhân';
$lang_module['data_usage_permission_content'] = 'Nội dung cảnh báo về việc cấp phép quyền sử dụng dữ liệu cá nhân';
$lang_module['data_usage_permission_placeholder'] = 'Ví dụ: Khi gửi dữ liệu, tôi xác nhận cấp quyền cho website khai thác các thông tin cá nhân mà tôi đã khai báo';
$lang_module['data_usage_permission_default'] = 'Khi gửi dữ liệu, tôi xác nhận cấp quyền cho website khai thác các thông tin cá nhân mà tôi đã khai báo';
$lang_module['antispam_law_warning'] = 'Hiển thị cảnh báo về luật chống tin rác';
...
$lang_module['pp'] = 'Thiết lập PP';
$lang_module['pp_desc'] = 'Permissions-Policy (PP) là tên của tiêu đề HTTP (HTTP response header) mà các trình duyệt hiện đại sử dụng để cho phép hoặc từ chối các tính năng được sử dụng trên trang web hoặc bất kỳ thẻ iframe nào trong trang web';
$lang_module['pp_desc2'] = 'Ví dụ bạn có thể quyết định video từ bên thứ ba nào được quyền tự động phát; giới hạn quyền sử dụng Camera, Mic và loa; cho phép iframe từ trang nào có thể dùng chức năng phóng to toàn màn hình; v.v...';
$lang_module['pp_desc3'] = 'Tiền thân của tiêu đề Permissions-Policy là Feature-Policy (FP). Các cấu hình ở đây cũng sẽ áp dụng luôn cho tiêu đề Feature-Policy';
$lang_module['pp_act'] = 'Kích hoạt PP';
$lang_module['pp_accelerometer'] = 'Thu thập thông tin về khả năng tăng tốc của thiết bị thông qua giao diện <code>Accelerometer</code>';
$lang_module['pp_ambient_light_sensor'] = 'Thu thập thông tin về lượng ánh trong môi trường xung quanh của thiết bị thông qua giao diện <code>AmbientLightSensor</code>';
$lang_module['pp_autoplay'] = 'Kiểm soát việc tự động phát của tập tin đa phương tiện';
$lang_module['pp_battery'] = 'Kiểm soát việc truy cập trạng thái pin của thiết bị';
$lang_module['pp_browsing_topics'] = 'Kiểm soát việc truy cập API chủ đề của thiết bị, ví dụ như thông tin về quảng cáo được cá nhân hóa';
$lang_module['pp_camera'] = 'Kiểm soát việc truy cập camera của thiết bị';
$lang_module['pp_display_capture'] = 'Kiểm soát việc sử dụng phương thức <code>getDisplayMedia()</code> để chụp nội dung màn hình';
$lang_module['pp_document_domain'] = 'Kiểm soát việc thay đổi giá trị <code>document.domain</code>';
$lang_module['pp_encrypted_media'] = 'Kiểm soát việc sử dụng API EME';
$lang_module['pp_execution_while_not_rendered'] = 'Kiểm soát tác vụ có được thực thi trong một khung không được hiển thị hay không. Ví dụ như thẻ iframe có thuộc tính <code>display: none;</code>';
$lang_module['pp_execution_while_out_of_viewport'] = 'Kiểm soát tác vụ có được thực thi trong một khung trong khi chúng nằm ngoài vùng hiển thị của khung hay không';
$lang_module['pp_fullscreen'] = 'Kiểm soát việc sử dụng lệnh toàn màn hình <code>Element.requestFullscreen()</code>';
$lang_module['pp_gamepad'] = 'Kiểm soát việc sử dụng API Gamepad';
$lang_module['pp_geolocation'] = 'Kiểm soát việc sử dụng Geolocation (lấy thông tin về địa điểm của thiết bị)';
$lang_module['pp_gyroscope'] = 'Kiểm soát việc truy cập thông tin về hướng của thiết bị thông qua giao diện Gyroscope';
$lang_module['pp_hid'] = 'Kiểm soát việc sử dụng API WebHID để kết nối với các thiết bị có giao diện con người không phổ biến hoặc kỳ lạ như bàn phím hoặc gamepad thay thế hay không';
$lang_module['pp_identity_credentials_get'] = 'Kiểm soát việc sử dụng FedCM hay không. Cụ thể hơn là <code>navigator.credentials.get()</code>';
$lang_module['pp_idle_detection'] = 'Kiểm soát việc phát hiện người dùng không sử dụng thiết bị trong một thời gian hay không thông qua API Idle Detection';
$lang_module['pp_local_fonts'] = 'Kiểm soát việc lấy danh sách các font được cài đặt trên thiết bị thông qua phương thức <code>Window.queryLocalFonts()</code>';
$lang_module['pp_magnetometer'] = 'Kiểm soát việc truy cập thông tin về hướng của thiết bị thông qua giao diện Magnetometer';
$lang_module['pp_microphone'] = 'Kiểm soát quyền sử dụng microphone';
$lang_module['pp_midi'] = 'Kiểm soát quyền sử dụng API Web MIDI';
$lang_module['pp_otp_credentials'] = 'Kiểm soát quyền sử dụng API WebOTP để yêu cầu mã OTP từ SMS được gửi đến thiết bị';
$lang_module['pp_payment'] = 'Kiểm soát quyền sử dụng API Payment Request';
$lang_module['pp_picture_in_picture'] = 'Kiểm soát việc phát video ở chế độ Picture-in-Picture (ảnh trong ảnh)';
$lang_module['pp_publickey_credentials_create'] = 'Kiểm soát quyền sử dụng <code>navigator.credentials.create(...)</code> để tạo khóa xác thực mới';
$lang_module['pp_publickey_credentials_get'] = 'Kiểm soát quyền sử dụng <code>navigator.credentials.get(...)</code> để lấy danh sách khóa xác thực đã được lưu trữ';
$lang_module['pp_screen_wake_lock'] = 'Kiểm soát quyền sử dụng API Screen Wake Lock để làm cho màn hình không được tắt hoặc không giảm độ sáng';
$lang_module['pp_serial'] = 'Kiểm soát quyền kết nối đến các thiết bị ngoại vi thông qua cổng nối tiếp';
$lang_module['pp_speaker_selection'] = 'Kiểm soát quyền liệt kê và chọn các thiết bị loa';
$lang_module['pp_storage_access'] = 'Kiểm soát các iframe được quyền sử dụng API Storage Access hay không';
$lang_module['pp_usb'] = 'Kiểm soát quyền sử dụng API WebUSB';
$lang_module['pp_web_share'] = 'Kiểm soát quyền sử dụng API Navigator.share()';
$lang_module['pp_window_management'] = 'Kiểm soát quyền sử dụng API Window Management để quản lý các cửa sổ trên nhiều màn hình hiển thị';
$lang_module['pp_xr_spatial_tracking'] = 'Kiểm soát quyền sử dụng API WebXR';
$lang_module['pp_source_hosts_note'] = 'Biểu thức nguồn hợp lệ có thể bao gồm các dạng: https://*.example.com, https://example.com. Dạng https://*.example.com không hỗ trợ trong tiêu đề Feature-Policy nên sẽ bị bỏ qua.';
$lang_module['pp_source_hosts'] = 'Danh sách các nguồn được chấp nhận';
$lang_module['pp_source_ignore'] = 'Không chỉ định chỉ thị này trong tiêu đề HTTP, việc kiểm soát tùy thuộc vào từng trình duyệt cụ thể';
$lang_module['pp_source_none'] = 'Tương đương \'none\' trong FP hoặc () trong PP - Cấm sử dụng từ mọi nguồn kể cả chính trang hiện tại';
$lang_module['pp_source_all'] = 'Tương đương * - Cho phép tất cả các nguồn được sử dụng';
