...
$lang_module['already_paid'] = 'Đã mua thành công';
...
$lang_module['install_manual_install'] = 'Ứng dụng này không hỗ trợ cài đặt tự động. Bạn có thể click vào nút tải về và làm theo hướng dẫn để cài đặt ứng dụng thủ công';
$lang_module['install_manual_install_danger'] = 'Ứng dụng này không hỗ trợ cài đặt tự động và cũng không có hướng dẫn cài đặt. Bạn có thể click vào nút tải về và cài đặt ứng dụng thủ công';
...
$lang_module['install_check_installed_error'] = 'Ứng dụng này đã tồn tại trên hệ thống. Để cài đặt mới, trước tiên cần xóa ứng dụng này khỏi hệ thống. Hãy nhấp <a href="%s">vào đây</a> để kiểm tra và xóa ứng dụng.';
$lang_module['install_check_installed_unsure'] = 'Hệ thống không thể kiểm tra kiểu ứng dụng này một cách tối ưu. Có thể việc cài mới sẽ ghi đè nội dung cũ. Bạn nên lưu ý vấn đề này trước khi cài đặt!';
...
$lang_module['install_file_downloading'] = 'Đang tải về';
$lang_module['install_check_require'] = 'Kiểm tra các ứng dụng bắt buộc';
$lang_module['install_check_require_fail'] = 'Để ứng dụng này có thể hoạt động, bạn cần phải cài đặt ứng dụng <strong>&quot;%s&quot;</strong> trước. Nhấp <a href="%s">vào đây</a> để xem thông tin về ứng dụng bắt buộc này';
...
$lang_module['install_check_paid_nologin'] = 'Hệ thống yêu cầu bạn đăng nhập Merchant Site để kiểm tra việc thanh toán ứng dụng. Nhấp <a href="%s">vào đây</a> để đăng nhập';
$lang_module['install_check_paid_unpaid'] = 'Ứng dụng này có phí. Bạn cần mua ứng dụng trước khi có thể cài đặt. Nhấp <a href="%s">vào đây</a> để mua.';
...
$lang_module['extUpdLoginRequire'] = 'Để nâng cấp ứng dụng này, trước hết bạn cần đăng nhập Merchant Site. Nhấp <strong><a href="%s">vào đây</a></strong> để đăng nhập';
...
$lang_module['autoinstall_uploaded_num_exists'] = 'Số file bị trùng lặp';
$lang_module['autoinstall_uploaded_num_invalid'] = 'Số file có cấu trúc không phù hợp';
$lang_module['autoinstall_error_uploadfile'] = 'Lỗi: không thể upload file lên hệ thống. Hãy thử CHMOD thư mục tmp';
$lang_module['autoinstall_error_uploadfile1'] = 'Lỗi: không thể upload file lên hệ thống. Có thể dung lượng file vượt quá %s';
