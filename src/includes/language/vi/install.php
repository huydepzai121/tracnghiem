...
$lang_module['if_chmod'] = 'Danh sách các file, folder trên máy chủ chưa được CHMOD';
...
$lang_module['ftp_user_note'] = 'Bí danh';
...
$lang_module['db_name'] = 'Tên CSDL';
$lang_module['db_name_note'] = 'Một số hosting đặt tiếp đầu tố cho tên CSDL. Bạn cần kiểm tra chính xác tên này.';
...
$lang_module['notesupport'] = 'Mọi nhu cầu về hỗ trợ kỹ thuật xin liên hệ tại <a href="https://nukeviet.vn" target="_blank"><strong>diễn đàn Nukeviet.VN</strong></a>.';
...
$lang_module['copyright'] = 'Chú ý: Việc đăng lại bài viết trên ở website hoặc các phương tiện truyền thông khác mà không ghi rõ nguồn https://nukeviet.vn là vi phạm bản quyền';
...
$lang_module['dev_mode_note'] = 'Chọn nếu bạn đang có mục đích cài đặt để lập trình, gỡ lỗi và không chọn nếu bạn cài đặt để sử dụng. Khi chọn tùy chọn này tính năng tự động sao lưu CSDL sẽ bị tắt, thông báo lỗi sẽ hiển thị lên màn hình và các máy chủ tìm kiếm bị chặn truy cập. Nếu chọn tùy chọn này và sau đó đưa website lên hoạt động chính thức bạn cần điều chỉnh lại các cài đặt cho phù hợp';
...
$lang_module['update_package_not_deleted'] = 'Không thể xóa gói cập nhật! Bạn hãy xóa thủ công các tệp và thư mục được liệt kê trong cảnh báo vừa xuất hiện. Chỉ sau đó website mới có thể hoạt động trở lại';
...
$lang_module['update_info_list_prosess'] = 'Bên dưới là danh sách các công việc sẽ thực hiện. Nhấp vào <strong>Bước kế tiếp</strong> để tiếp tục';
...
$lang_module['update_task_all_complete_alert'] = 'Các công việc đã thực hiện. Có một số công việc bị lỗi, tuy nhiên có thể bỏ qua. Danh sách công việc lỗi đã được đánh dấu. Bạn có thể kiểm tra lại sau.';
...
$lang_module['update_task_do2_error'] = 'bị lỗi, do đó việc nâng cấp không thể tiếp tục. Truy cập <a href="%s">vào đây</a> để thông báo lỗi và nhận hỗ trợ.';
...
$lang_module['update_file_backup_error'] = 'Hệ thống không thể tự động sao lưu được nên bạn hãy  sao lưu thủ công';
...
$lang_module['update_data_not_allow'] = 'Việc sửa đổi CSDL đã diễn ra, do đó bạn không được sao lưu CSDL nữa. Hãy tiếp tục thực hiện các công việc còn lại';
