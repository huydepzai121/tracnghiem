...
$lang_module['saved_return'] = 'Nhấp vào đây để xem danh sách các tập tin đã sao lưu và tải về.';
...
$lang_module['file_backup_empty'] = 'Chưa có tập tin sao lưu dữ liệu nào';
