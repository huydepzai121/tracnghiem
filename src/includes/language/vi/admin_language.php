...
$lang_module['region_settings'] = 'Thiết lập bản địa hóa';
$lang_module['region_numbers'] = 'Số';
$lang_module['region_numbers_p'] = 'Số dương';
$lang_module['region_numbers_n'] = 'Số âm';
$lang_module['region_currency'] = 'Tiền tệ';
$lang_module['region_currency_p'] = 'Tiền dương';
$lang_module['region_currency_n'] = 'Tiền âm';
$lang_module['region_date'] = 'Ngày';
$lang_module['region_time'] = 'Giờ';
$lang_module['region_display_short'] = 'Ngắn gọn';
$lang_module['region_display_long'] = 'Đầy đủ';
$lang_module['decimal_symbol'] = 'Kí tự thập phân';
$lang_module['thousand_symbol'] = 'Kí tự phần nghìn';
$lang_module['decimal_length'] = 'Số kí tự thập phân';
$lang_module['single_quote'] = 'Nháy đơn';
$lang_module['comma'] = 'Phảy';
$lang_module['dot'] = 'Chấm';
$lang_module['leading_zero'] = 'Ẩn số 0 đứng đầu phần nguyên (ví dụ .5, ,5)';
$lang_module['trailing_zero'] = 'Ẩn số 0 đứng cuối phần thập phân';
$lang_module['currency_symbol'] = 'Đơn vị tiền tệ';
$lang_module['currency_display'] = 'Cách hiển thị';
$lang_module['currency_display0'] = 'Số tiền + đơn vị';
$lang_module['currency_display1'] = 'Số tiền + khoảng cách + đơn vị';
$lang_module['currency_display2'] = 'Đơn vị + số tiền';
$lang_module['currency_display3'] = 'Đơn vị + khoảng cách + số tiền';
$lang_module['first_day_of_week'] = 'Bắt đầu tuần';
$lang_module['char_am'] = 'Kí tự thay thế AM';
