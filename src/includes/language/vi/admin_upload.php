...
$lang_module['upload_file_error_movefile'] = 'Lỗi: không có quyền tạo file. Vui lòng kiểm tra lại chmod thư mục';
...
$lang_module['recreatethumb_note'] = 'Chú ý: Việc này này sẽ dẫn đến việc xóa tất cả thumb, thư mục con thuộc thư mục này và tạo lại ảnh thumb theo cấu hình mới. Quá trình này có thể kéo dài rất lâu. Vui lòng không đóng trình duyệt';
...
$lang_module['rename_error_folder'] = 'Lỗi: Hệ thống không đổi được tên thư mục';
...
$lang_module['delete_folder'] = 'Bạn có chắc muốn xóa thư mục này không? Xóa thư mục này đồng nghĩa với việc toàn bộ các file trong nó cũng bị xóa';
...
$lang_module['notlogo'] = 'Lỗi: không tìm thấy logo. Có thể bạn chưa cấu hình chèn logo hoặc file đã bị xóa';
$lang_module['upload_logo'] = 'Logo được chèn vào ảnh';
...
$lang_module['sys_max_size'] = 'Máy chủ của bạn cho phép tải lên tệp tin tối đa';
...
$lang_module['upload_chunk_help'] = 'Chức năng này hỗ trợ chia nhỏ tập tin upload thành nhiều gói nhỏ, hỗ trợ upload tập tin lớn đến rất lớn lên máy chủ. Nếu bạn không có ý định cho phép upload các tập tin lớn hãy để trống giá trị bên trên';
