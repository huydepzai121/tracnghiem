...
$lang_module['curl_support'] = 'Support cURL library';
...
$lang_module['notesupport'] = 'All technical support, please contact <a href="https://nukeviet.vn" target="_blank"><strong>forum Nukeviet.VN</strong></a>.';
...
$lang_module['copyright'] = 'Note: The above article reprinted at the website or other media sources not specify the source https://nukeviet.vn is copyright infringement';
...
$lang_module['dev_mode'] = 'Development mode';
$lang_module['dev_mode_note'] = 'Select this option if you intend to set up for programming and debugging. Do not select it if you are installing for regular use. When this option is selected, the automatic database backup feature will be disabled, error messages will be displayed on the screen, and search engines will be blocked from accessing the site. If you choose this option and later launch the website for official use, you will need to adjust the settings accordingly';
...
$lang_module['update_semiautomatic'] = 'This is the update package requires you to move files before you can upgrade the database. Move all files and folders in <strong>install/update/</strong> out of the website root directory (the directory containing index.php, robots.php ...). After successful implementation click "<strong>next step</strong>" to continue work';
...
$lang_module['update_ftp_nosupport'] = 'WARNING: Hosting does not support FTP, we recommend that you perform manually move the files and folders in <strong>install/update/</strong> out of the website root directory (the directory containing index.php, robots.php ...).';
...
$lang_module['update_move_redo_manual'] = 'Or you should move the files and folders manually in <strong>install/update/</strong> out of the website, in root directory (the directory containing index.php, robots.php ...).';
