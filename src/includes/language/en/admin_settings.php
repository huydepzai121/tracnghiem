...
$lang_module['rewrite'] = 'Activate rewrite in user area';
$lang_module['rewrite_admin'] = 'Activate rewrite in admin area';
...
$lang_module['blank_operation'] = 'Processing output buffer';
$lang_module['blank_operation_help'] = 'Enable this option and the system will automatically optimize some issues such as cleaning up extra blank lines and extra spaces before sending to the user\'s browser';
...
$lang_module['cron_launcher_interval'] = 'Repetition frequency';
$lang_module['cron_launcher_interval1'] = 'Repeat checking and executing cronjobs every';
...
$lang_module['DKIM_private_key_error'] = 'Unable to generate private key for DKIM, please check OpenSSL settings on server';
...
$lang_module['DKIM_empty'] = 'No DKIM-signature has been created yet';
...
$lang_module['sample_tab'] = 'Sample Server Configuration File';
...
$lang_module['pp'] = 'PP setting';
$lang_module['pp_desc'] = 'Permissions Policy provides mechanisms for web developers to explicitly declare what functionality can and cannot be used on a website. You define a set of "policies" that restrict what APIs the site\'s code can access or modify the browser\'s default behavior for certain features. This allows you to enforce best practices, even as the codebase evolves — as well as more safely compose third-party content';
$lang_module['pp_desc2'] = 'Examples of what you can do with Permissions Policy: change the default behavior of autoplay on mobile and third-party videos. Restrict a site from using sensitive devices like the camera, microphone, or speakers. Allow iframes to use the Fullscreen API. Stop items from being scripted if they are not visible in the viewport, to improve performance';
$lang_module['pp_desc3'] = 'Permissions-Policy is renamed from Feature-Policy (FP). The configurations here will also apply to the Feature-Policy header';
$lang_module['pp_act'] = 'Active PP';
$lang_module['pp_accelerometer'] = 'Controls whether the current document is allowed to gather information about the acceleration of the device through the Accelerometer interface.';
$lang_module['pp_ambient_light_sensor'] = 'Controls whether the current document is allowed to gather information about the amount of light in the environment around the device through the AmbientLightSensor interface.';
$lang_module['pp_autoplay'] = 'Controls whether the current document is allowed to autoplay media requested through the HTMLMediaElement interface.';
$lang_module['pp_battery'] = 'Controls whether the use of the Battery Status API is allowed.';
$lang_module['pp_browsing_topics'] = 'Controls access to the Topics API.';
$lang_module['pp_camera'] = 'Controls whether the current document is allowed to use video input devices.';
$lang_module['pp_display_capture'] = 'Controls whether or not the current document is permitted to use the getDisplayMedia() method to capture screen contents.';
$lang_module['pp_document_domain'] = 'Controls whether the current document is allowed to set document.domain.';
$lang_module['pp_encrypted_media'] = 'Controls whether the current document is allowed to use the Encrypted Media Extensions API (EME).';
$lang_module['pp_execution_while_not_rendered'] = 'Controls whether tasks should execute in frames while they\'re not being rendered (e.g. if an iframe is hidden or has display: none set).';
$lang_module['pp_execution_while_out_of_viewport'] = 'Controls whether tasks should execute in frames while they\'re outside of the visible viewport.';
$lang_module['pp_fullscreen'] = 'Controls whether the current document is allowed to use Element.requestFullscreen().';
$lang_module['pp_gamepad'] = 'Controls whether the current document is allowed to use the Gamepad API.';
$lang_module['pp_geolocation'] = 'Controls whether the current document is allowed to use the Geolocation Interface.';
$lang_module['pp_gyroscope'] = 'Controls whether the current document is allowed to gather information about the orientation of the device through the Gyroscope interface.';
$lang_module['pp_hid'] = 'Controls whether the current document is allowed to use the WebHID API to connect to uncommon or exotic human interface devices such as alternative keyboards or gamepads.';
$lang_module['pp_identity_credentials_get'] = 'Controls whether the current document is allowed to use the Federated Credential Management API (FedCM), and more specifically the navigator.credentials.get() method with an identity option.';
$lang_module['pp_idle_detection'] = 'Controls whether the current document is allowed to use the Idle Detection API to detect when users are interacting with their devices.';
$lang_module['pp_local_fonts'] = 'Controls whether the current document is allowed to gather data on the user\'s locally-installed fonts via the Window.queryLocalFonts() method.';
$lang_module['pp_magnetometer'] = 'Controls whether the current document is allowed to gather information about the orientation of the device through the Magnetometer interface.';
$lang_module['pp_microphone'] = 'Controls whether the current document is allowed to use audio input devices.';
$lang_module['pp_midi'] = 'Controls whether the current document is allowed to use the Web MIDI API.';
$lang_module['pp_otp_credentials'] = 'Controls whether the current document is allowed to use the WebOTP API to request a one-time password (OTP) from a specially-formatted SMS message sent by the app\'s server.';
$lang_module['pp_payment'] = 'Controls whether the current document is allowed to use the Payment Request API.';
$lang_module['pp_picture_in_picture'] = 'Controls whether the current document is allowed to play a video in a Picture-in-Picture mode via the corresponding API.';
$lang_module['pp_publickey_credentials_create'] = 'Controls whether the current document is allowed to use the Web Authentication API to create new asymmetric key credentials.';
$lang_module['pp_publickey_credentials_get'] = 'Controls whether the current document is allowed to use the Web Authentication API to retrieve already stored public-key credentials.';
$lang_module['pp_screen_wake_lock'] = 'Controls whether the current document is allowed to use Screen Wake Lock API to indicate that device should not turn off or dim the screen.';
$lang_module['pp_serial'] = 'Controls whether the current document is allowed to use the Web Serial API to communicate with serial devices.';
$lang_module['pp_speaker_selection'] = 'Controls whether the current document is allowed to use the Audio Output Devices API to list and select speakers.';
$lang_module['pp_storage_access'] = 'Controls whether a document loaded in a third-party context (i.e. embedded in an &lt;iframe&gt;) is allowed to use the Storage Access API to request access to unpartitioned cookies.';
$lang_module['pp_usb'] = 'Controls whether the current document is allowed to use the WebUSB API.';
$lang_module['pp_web_share'] = 'Controls whether or not the current document is allowed to use the Navigator.share() of Web Share API to share text, links, images, and other content to arbitrary destinations of user\'s choice, e.g. mobile apps.';
$lang_module['pp_window_management'] = 'Controls whether or not the current document is allowed to use the Window Management API to manage windows on multiple displays.';
...
$lang_module['pp_source_hosts_note'] = 'Valid source expressions can include the following forms: https://*.example.com, https://example.com. The format https://*.example.com is not supported in the Feature-Policy header and will be ignored.';
$lang_module['pp_source_hosts'] = 'List of accepted sources';
$lang_module['pp_source_ignore'] = 'Do not specify this directive in the HTTP header, control is up to the specific browser';
$lang_module['pp_source_none'] = 'Equivalent to \'none\' in FP or () in PP - Denied from any source including the current page itself';
$lang_module['pp_source_all'] = 'Equivalent * - Allows all sources to be used';
