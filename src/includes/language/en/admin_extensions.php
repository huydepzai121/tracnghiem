...
$lang_module['already_paid'] = 'Already purchased';
...
$lang_module['install_file_downloading'] = 'Downloading';
$lang_module['install_check_require'] = 'Mandatory inspection applications';
$lang_module['install_check_require_fail'] = 'For this application to work, you need to install the <strong>&quot;%s&quot;</strong> before. <a href="%s">Click here</a> to view information about the mandatory application';
...
$lang_module['install_check_paid_nologin'] = 'The system requires you to log Merchant Site to check the payment of application fees. <a href="%s">Click here</a> to login';
$lang_module['install_check_paid_unpaid'] = 'This application fees, you need to buy before the application can be installed. <a href="%s">Click here</a> to buy.';
