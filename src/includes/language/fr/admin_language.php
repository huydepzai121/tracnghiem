...
$lang_module['nv_admin_delete_files'] = 'Supprimer les fichiers';
...
$lang_module['nv_lang_delete_files_ok'] = 'Les fichiers suivants ont été supprimés';
...
$lang_module['region_settings'] = 'Paramètres de région';
$lang_module['region_numbers'] = 'Nombres';
$lang_module['region_numbers_p'] = 'Positive';
$lang_module['region_numbers_n'] = 'Négative';
$lang_module['region_currency'] = 'Devise';
$lang_module['region_currency_p'] = 'Positive';
$lang_module['region_currency_n'] = 'Négative';
$lang_module['region_date'] = 'Date';
$lang_module['region_time'] = 'Temps';
$lang_module['region_display_short'] = 'Courte';
$lang_module['region_display_long'] = 'Longue';
$lang_module['decimal_symbol'] = 'Symbole décimal';
$lang_module['thousand_symbol'] = 'Symbole de regroupement de chiffres';
$lang_module['decimal_length'] = 'Nombre de chiffres après la virgule';
$lang_module['single_quote'] = 'Simple citation';
$lang_module['comma'] = 'Virgule';
$lang_module['dot'] = 'Dot';
$lang_module['leading_zero'] = 'Couper le zéro non significatif (par exemple ,5, ,5)';
$lang_module['trailing_zero'] = 'Couper le zéro final';
$lang_module['currency_symbol'] = 'Symbole de la monnaie';
$lang_module['currency_display'] = 'Affichage des devises';
$lang_module['currency_display0'] = 'Montant + symbole';
$lang_module['currency_display1'] = 'Montant + espace + symbole';
$lang_module['currency_display2'] = 'Symbole + montant';
$lang_module['currency_display3'] = 'Symbole + espace + montant';
$lang_module['first_day_of_week'] = 'Premier jour de la semaine';
$lang_module['char_am'] = 'Symbole AM';
$lang_module['char_pm'] = 'Symbole PM';
$lang_module['datetime_format_guide'] = 'En savoir plus sur la syntaxe du format de date et d\'heure';
$lang_module['datetime_format_guide1'] = 'ici';
$lang_module['date_getpost_error'] = 'Format de date invalide';
$lang_module['date_get'] = 'Formater sous obtenir forme';
$lang_module['date_post'] = 'Format sous post forme';
