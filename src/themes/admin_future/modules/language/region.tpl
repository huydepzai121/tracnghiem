        ...
        <div class="card">
            <div class="card-header card-header-tabs">
                <ul class="nav nav-tabs nav-justified" id="tab-region">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-truncate{$TAB eq 'currency' ? ' active' : ''}" data-bs-toggle="tab" id="link-currency" data-tab="currency" data-bs-target="#tab-currency" aria-current="{$TAB eq 'currency' ? 'true' : 'false'}" role="tab" aria-controls="tab-currency" aria-selected="{$TAB eq 'currency' ? 'true' : 'false'}" href="#" data-location="{$smarty.const.NV_BASE_SITEURL}{$smarty.const.NV_ADMINDIR}/index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}&amp;tab=currency">{$LANG->getModule('region_currency')}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-truncate{$TAB eq 'date' ? ' active' : ''}" data-bs-toggle="tab" id="link-date" data-tab="date" data-bs-target="#tab-date" aria-current="{$TAB eq 'numbers' ? 'date' : 'false'}" role="tab" aria-controls="tab-date" aria-selected="{$TAB eq 'date' ? 'true' : 'false'}" href="#" data-location="{$smarty.const.NV_BASE_SITEURL}{$smarty.const.NV_ADMINDIR}/index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}&amp;tab=date">{$LANG->getModule('region_date')}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-truncate{$TAB eq 'time' ? ' active' : ''}" data-bs-toggle="tab" id="link-time" data-tab="time" data-bs-target="#tab-time" aria-current="{$TAB eq 'time' ? 'true' : 'false'}" role="tab" aria-controls="tab-time" aria-selected="{$TAB eq 'time' ? 'true' : 'false'}" href="#" data-location="{$smarty.const.NV_BASE_SITEURL}{$smarty.const.NV_ADMINDIR}/index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}&amp;tab=time">{$LANG->getModule('region_time')}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <form id="form-region" method="post" class="ajax-submit" action="{$smarty.const.NV_BASE_SITEURL}{$smarty.const.NV_ADMINDIR}/index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}" novalidate>
