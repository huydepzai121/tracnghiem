<div class="card border-primary border-3 border-bottom-0 border-start-0 border-end-0">
    <div class="card-body pt-4">
        <form method="post" class="ajax-submit" action="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}" novalidate>
            <div class="row mb-3">
                <label for="ele_viewtype" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('config_view_type')}</label>
            ...
            <div class="row mb-3">
                <label for="ele_per_page" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('config_view_type_page')}</label>
                <div class="col-sm-4 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <label for="ele_related_articles" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('config_view_related_articles')}</label>
                <div class="col-sm-4 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <label for="ele_facebookapi" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('config_facebookapi')}</label>
                <div class="col-sm-4 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <div class="col-sm-3 col-form-label text-sm-end pt-0">{$LANG->getModule('socialbutton')}</div>
