...
<div class="card border-primary border-3 border-bottom-0 border-start-0 border-end-0">
    <div class="card-body pt-4">
        <form method="post" class="ajax-submit" action="{$smarty.const.NV_BASE_SITEURL}{$smarty.const.NV_ADMINDIR}/index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}&amp;mod={$DATA.title}" novalidate>
            ...
            <div class="row mb-3">
                <label for="element_mod_name" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('module_name')} <span class="text-danger">(*)</span></label>
            ...
            <div class="row mb-3">
                <label for="element_custom_title" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('custom_title')} <span class="text-danger">(*)</span></label>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <label for="element_admin_title" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('admin_title')}</label>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
                    <input type="text" class="form-control" id="element_admin_title" name="admin_title" value="{$DATA.admin_title}" maxlength="100">
                </div>
            </div>
            <div class="row mb-3">
                <label for="element_theme" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('theme')}</label>
                <div class="col-12 col-sm-4 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <label for="element_mobile" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('mobile')}</label>
                <div class="col-12 col-sm-4 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <label for="element_site_title" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('site_title')}</label>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
                    <input type="text" class="form-control" id="element_site_title" name="site_title" value="{$DATA.site_title}" maxlength="255">
                </div>
            </div>
            <div class="row mb-3">
                <label for="element_description" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('description')}</label>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
                    <input type="text" class="form-control" id="element_description" name="description" value="{$DATA.description}" maxlength="255">
                </div>
            </div>
            <div class="row mb-3">
                <label for="element_keywords" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('keywords')}</label>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="act" value="1"{if $DATA.act} checked="checked"{/if} role="switch" id="element_act">
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="rss" value="1"{if $DATA.rss} checked="checked"{/if} role="switch" id="element_rss">
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="sitemap" value="1"{if $DATA.sitemap} checked="checked"{/if} role="switch" id="element_sitemap">
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getGlobal('groups_view')}</div>
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5">
                    {foreach from=$GROUPS_LIST key=group_id item=group_name}
                    {if $group_id gt 2}
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="groups_view[]" value="{$group_id}" id="element_groups_view_{$group_id}"{if in_array($group_id, $DATA.groups_view)} checked="checked"{/if}>
            ...
            {/if}
            <div class="row mb-3">
                <label for="element_icon" class="col-12 col-sm-3 col-form-label text-sm-end">{$LANG->getModule('icon')}</label>
                <div class="col-12 col-sm-4 col-lg-6 col-xxl-5">
