...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="card-title mb-0">
            <i class="fas fa-graduation-cap me-2"></i>Danh sách lớp học
        </h5>
    </div>
                ...
                <table class="table table-striped table-hover align-middle mb-0">
                    <thead >
                        <tr>
                            ...
                            <th>
                                <i class="fas fa-graduation-cap me-1"></i>{LANG.title}
                            </th>
                            <th>
                    ...
                    <tbody>
                        <!-- BEGIN: loop -->
                        <tr class="class-row" data-id="{VIEW.id}">
                            <td>
...
<div class="card shadow-sm mt-4">
    <div class="card-header bg-success text-white">
        <h5 class="card-title mb-0">
            <i class="fas fa-plus-circle me-2"></i>Thêm/Sửa lớp học
        </h5>
    </div>
    <div class="card-body">
        <form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input class="form-control" type="text" name="title" value="{ROW.title}"
                           required="required" placeholder="Nhập tên lớp học..."
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-9">
                    <textarea class="form-control" name="note" rows="3"
                              placeholder="Nhập ghi chú cho lớp học...">{ROW.note}</textarea>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    window.nv_change_weight = function(id) {
        ...
        var $row = $select.closest('.class-row');
        ...
        $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=exams_bank_class&nocache=' + new Date().getTime(),
               ...
               function(res) {
                   ...
                   setTimeout(function() {
                       ...
                       window.location.href = script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=exams_bank_class';
                   }, 1500);
               });
    };
    ...
    window.nv_change_status = function(id) {
        ...
        var $row = $checkbox.closest('.class-row');
