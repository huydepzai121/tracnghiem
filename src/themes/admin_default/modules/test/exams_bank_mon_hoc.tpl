                ...
                <table class="table table-striped table-hover align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <i class="fas fa-book me-1"></i>{LANG.title}
                            </th>
                            <th>
...
<div class="card shadow-sm mt-4">
    <div class="card-header bg-success text-white">
        <h5 class="card-title mb-0">
            <i class="fas fa-plus-circle me-2"></i>Thêm/Sửa môn học
        </h5>
    </div>
    <div class="card-body">
        <form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <input class="form-control" type="text" name="title" value="{ROW.title}"
                           required="required" placeholder="Nhập tên môn học..."
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-9">
                    <textarea class="form-control" name="note" rows="3"
                              placeholder="Nhập ghi chú cho môn học...">{ROW.note}</textarea>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    window.nv_change_weight = function(id) {
        ...
        $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=exams_bank_mon_hoc&nocache=' + new Date().getTime(),
               ...
               function(res) {
                   ...
                   setTimeout(function() {
                       ...
                       window.location.href = script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=exams_bank_mon_hoc';
                   }, 1500);
               });
    };
    ...
    window.nv_change_status = function(id) {
        ...
        var $row = $checkbox.closest('.subject-row');
