            ...
            <div class="row">
                ...
                <div class="col-md-10 margin-bottom-lg">
                    <ul class="column-margin-left">
                        <!-- BEGIN: othernews -->
                        <li class="icon_list clearfix"><a class="show black h4" href="{othernews.link}" title="{othernews.title}"> <!-- BEGIN: image --> <img src="{othernews.imgsource}" alt="{othernews.title}" class="img-thumbnail pull-right margin-left-sm" style="width: 65px;" /> <!-- END: image --> {othernews.titleclean60}
                        </a></li>
                        <!-- END: othernews -->
                    </ul>
                </div>
