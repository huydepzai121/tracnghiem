                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="margin-bottom">
                            <img class="captchaImg mr-1" src="{ASSETS_STATIC_URL}/images/pix.svg" width="{NV_GFX_WIDTH}" height="{NV_GFX_HEIGHT}" alt="" title="" /><span class="pointer" data-toggle="change_captcha" data-obj="#modal-captcha-value" title="{LANG.captcharefresh}"><em class="fa fa-refresh"></em></span>
                        </div>
                        <div class="margin-bottom">
                            <div>
