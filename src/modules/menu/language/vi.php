...
$lang_module['error_menu_block'] = 'Vui lòng nhập tên khối menu';
...
$lang_module['add_item'] = 'Thêm menu vào khối';
$lang_module['title'] = 'Tên mục';
$lang_module['item_menu'] = 'Các mục thuộc module';
$lang_module['chomodule'] = 'Liên kết đến module';
$lang_module['cho_module_item'] = 'Liên kết đến mục của module';
$lang_module['select'] = 'Chọn';
$lang_module['note'] = 'Ghi chú';
$lang_module['link'] = 'URL liên kết';
$lang_module['module'] = 'Module';
$lang_module['op'] = 'op';
$lang_module['path'] = 'path';
$lang_module['target'] = 'Mở liên kết';
$lang_module['type_target1'] = 'Ở trang hiện tại';
$lang_module['type_target2'] = 'Bằng tab mới';
$lang_module['type_target3'] = 'Bằng cửa sổ mới';
$lang_module['cat'] = 'Nếu xóa menu này, ';
$lang_module['cat0'] = 'Là mục chính';
$lang_module['cho_item'] = 'Chọn loại của module';
$lang_module['cats'] = 'Thuộc mục';
$lang_module['caton'] = ' menu con cũng sẽ bị xóa. Bạn đồng ý chứ?';
$lang_module['name_block'] = 'Khối menu';
$lang_module['here'] = 'đây';
$lang_module['groups'] = 'Nếu chọn &laquo;Nhóm người dùng&raquo; hãy đánh dấu vào các nhóm bên dưới';
...
$lang_module['add_type_active'] = 'Thêm hiệu ứng active';
$lang_module['add_type_active_0'] = 'Khi URL trang hiện tại khớp với liên kết của menu';
$lang_module['add_type_active_1'] = 'Khi URL trang hiện tại có phần đầu giống liên kết của menu';
$lang_module['add_type_active_2'] = 'Khi URL trang hiện tại có chứa liên kết của menu';
$lang_module['add_type_css'] = 'Gán CSS';
...
$lang_module['msgnocheck'] = 'Bạn cần chọn ít nhất một menu để thực hiện';
$lang_module['click_to_view'] = 'Click để xem';
$lang_module['groups_view'] = 'Quyền xem';
$lang_module['no_submenu'] = 'Không có menu con';
