...
class simple_html_dom_node
{
    ...
    protected function seek($selector, &$ret, $parent_cmd, $lowercase = false)
    {
        ...
        if ($parent_cmd === ' ') { // Descendant Combinator
            ...
            $nodes = $this->children;
        } elseif ($parent_cmd === '+' && $this->parent && in_array($this, $this->parent->children)) { // Next-Sibling Combinator
    ...
    protected function parse_selector($selector_string)
    {
        ...
        preg_match_all($pattern, trim($selector_string) . ' ', // Add final ' ' as pseudo separator
    ...
    protected function parse_charset()
    {
        ...
        if (empty($charset)) {
            ...
            if (function_exists('mb_detect_encoding')) {
                ...
                $charset = mb_detect_encoding($this->doc . 'ascii', $encoding_list = array(
                    'UTF-8',
                    'CP1252'
                ));
