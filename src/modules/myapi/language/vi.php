...
$lang_module['auth_method_none'] = 'Không xác thực';
...
$lang_module['saveopt1'] = 'Cấu hình API module chỉ áp dụng cho %s';
$lang_module['saveopt2'] = 'Cấu hình API module áp dụng cho tất cả ngôn ngữ';
$lang_module['saveopt3'] = 'Cấu hình API module áp dụng cho %s và chuyển đến cấu hình cho %s';
