...
$lang_module['related_articles'] = 'Articles connexes';
$lang_module['related_sarticles'] = 'Connexes';
$lang_module['related_articles_ph'] = 'Entrez au moins 2 caractères pour rechercher par nom d\'article...';
$lang_module['related_articles_p0'] = 'Ne pas afficher';
$lang_module['related_articles_p1'] = 'Sous l\'introduction courte';
$lang_module['related_articles_p2'] = 'À la fin de l\'article, au-dessus de l\'auteur';
...
$lang_module['search_no_result'] = 'Aucun résultat ne correspond à vos critères de recherche';
...
$lang_module['from_date_short'] = 'depuis';
$lang_module['to_date_short'] = 'à';
...
$lang_module['name_empty'] = 'L\'article n\'a pas de titre';
$lang_module['alias'] = 'Alias';
$lang_module['alias_get'] = 'Générer un lien permanent à partir du titre';
...
$lang_module['setting_schema_type'] = 'Type de données structurées par défaut lors de la création d\'un article';
$lang_module['setting_schema_type_help'] = 'Choisissez NewsArticle si le contenu est un journal en ligne ou des actualités. Choisissez BlogPosting si le contenu est un partage personnel, une expérience ou un journal. Choisissez Article si vous n\'êtes pas sûr que le contenu soit un blog ou des actualités';
...
$lang_module['content_sourceid_guide'] = 'Entrez ou tapez pour trouver la source';
...
$lang_module['action_not_allowed'] = 'Votre action n\'est actuellement pas autorisée. Veuillez enregistrer les données modifiées actuelles et réessayer';
$lang_module['setting_copy_news'] = 'Nouvelles de copie';
$lang_module['title_copy_news'] = 'Copier l\'article';
$lang_module['setting_auto_save'] = 'Activer la sauvegarde automatique des articles';
$lang_module['setting_auto_save_help'] = 'Lorsque cette option est activée, les brouillons seront automatiquement envoyés au serveur pour éviter toute perte de données. Cependant, si vous rédigez un article très long, le navigateur peut devenir lent à répondre';
...
$lang_module['admin_topic_sl'] = 'Choisissez un sujet';
$lang_module['admin_topic_slnone'] = 'Ne pas sélectionner';
$lang_module['admin_topic_manual'] = 'Entrez un nouveau sujet';
...
$lang_module['all_articles'] = 'Tous les articles';
$lang_module['draft_not_allowed'] = 'Vous n\'avez plus l\'autorisation de modifier cet article';
$lang_module['draft_count'] = 'Vous avez %s brouillons en cours';
$lang_module['draft_continue'] = 'Continuer';
$lang_module['draft_list'] = 'Liste des brouillons en cours';
