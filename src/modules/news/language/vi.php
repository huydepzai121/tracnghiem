...
$lang_module['nocatpage'] = 'Lỗi: không có chuyên mục';
$lang_module['other'] = 'Các tin khác';
$lang_module['detail'] = 'Chi tiết tin';
$lang_module['more'] = 'Xem tiếp...';
$lang_module['sendmail'] = 'Giới thiệu bài viết cho bạn bè';
...
$lang_module['sendmail_content'] = 'Lời nhắn của bạn';
$lang_module['sendmail_submit'] = 'Gửi';
$lang_module['sendmail_error'] = 'Bạn không có quyền truy cập';
$lang_module['sendmail_err_name'] = 'Vui lòng nhập chính xác tên của bạn';
$lang_module['sendmail_err_yourmail'] = 'Lỗi! Bạn phải điền email';
$lang_module['sendmail_err_mail'] = 'Vui lòng nhập chính xác địa chỉ email người nhận';
$lang_module['sendmail_limit_sendmail'] = 'Chúng tôi đã gửi tin nhắn giới thiệu về bài viết đến %s cách đây không lâu. Để gửi lại tin nhắn, hãy thực hiện thao tác này sau %d phút.';
$lang_module['sendmail_success'] = 'Tin nhắn giới thiệu đã được gửi đến %s. Cảm ơn bạn!';
...
$lang_module['print_page'] = 'In bài viết này';
...
$lang_module['related_articles'] = 'Tin bài liên quan';
$lang_module['related_sarticles'] = 'Liên quan';
$lang_module['related_articles_ph'] = 'Nhập ít nhất 2 kí tự để tìm theo tên bài viết...';
$lang_module['related_articles_p0'] = 'Không hiển thị';
$lang_module['related_articles_p1'] = 'Dưới giới thiệu ngắn gọn';
$lang_module['related_articles_p2'] = 'Cuối bài, trên tác giả';
$lang_module['savefile'] = 'Lưu bài viết này';
$lang_module['rating'] = 'Xếp hạng bài viết';
$lang_module['rating_average'] = 'Điểm trung bình theo thang điểm 5 là';
$lang_module['rating_count'] = 'lượt xếp hạng';
$lang_module['stringrating'] = 'Tổng số điểm là: %1$s sau %2$s lượt xếp hạng';
$lang_module['star_note'] = 'Click để xếp hạng bài viết';
...
$lang_module['rating_error1'] = 'Xếp hạng không hợp lệ';
$lang_module['rating_error2'] = 'Bạn đã xếp hạng bài viết này rồi';
$lang_module['rating_success'] = 'Xếp hạng của bạn đã được ghi nhận';
...
$lang_module['search_no_result'] = 'Không có kết quả nào phù hợp với điều kiện bạn đã chọn';
...
$lang_module['empty_data_search'] = 'Hãy khai báo hoặc lựa chọn ít nhất một trong các trường: Từ tìm kiếm, Tìm kiếm trong chuyên mục, Từ ngày, Đến ngày';
$lang_module['search_word_short'] = 'Từ tìm kiếm quá ngắn. Vui lòng nhập ít nhất %d ký tự';
$lang_module['search_in_module'] = 'trong mục';
$lang_module['search_catid_error'] = 'Lỗi: Chuyên mục bạn đã chọn không tồn tại.';
...
$lang_module['from_date_short'] = 'từ';
$lang_module['to_date_short'] = 'đến';
...
$lang_module['type_title'] = 'Kiểu tìm kiếm';
$lang_module['finter_title'] = 'Thời gian';
$lang_module['source_title'] = 'Nguồn tin';
$lang_module['tags'] = 'Tags';
$lang_module['keywords'] = 'Từ khóa';
$lang_module['no_permission'] = 'Rất tiếc, bạn chưa được cấp quyền xem bài viết này. Vui lòng liên hệ Quản trị site để biết thêm chi tiết';
...
$lang_module['imgposition'] = 'Vị trí hình minh họa';
...
$lang_module['name_empty'] = 'Bài viết chưa có tiêu đề';
$lang_module['alias'] = 'Liên kết tĩnh';
$lang_module['alias_get'] = 'Tạo liên kết tĩnh từ tiêu đề';
...
$lang_module['save_content_waite'] = 'Bài viết bạn gửi đã được hệ thống ghi nhận.<br />Ban quản trị site sẽ kiểm tra và đăng bài viết trong thời gian sớm nhất.<br />Trình duyệt sẽ tự động chuyển về trang quản lý bài viết.';
$lang_module['save_content_waite_home'] = 'Bài viết bạn gửi đã được hệ thống ghi nhận.<br />Ban quản trị site sẽ kiểm tra và đăng bài viết trong thời gian sớm nhất.<br />Trình duyệt sẽ tự động chuyển về trang chủ.';
$lang_module['save_draft_ok'] = 'Bài viết đã được lưu nháp thành công';
$lang_module['error_content_management'] = 'Lỗi: Bạn chưa được cấp quyền để quản lý bài viết';
$lang_module['errorsave'] = 'Không thể cập nhật nội dung. Vui lòng kiểm tra lại liên kết tĩnh của bài viết, nó có thể bị trùng lặp';
...
$lang_module['action_1'] = 'Xuất bản';
$lang_module['action_4'] = 'Lưu nháp';
$lang_module['action_5'] = 'Chuyển duyệt bài';
...
$lang_module['viewdescription'] = 'Hiển thị nội dung chi tiết khi xem chuyên mục';
$lang_module['viewdescription_0'] = 'Không hiển thị ';
$lang_module['viewdescription_1'] = 'Hiển thị tại trang số 1 của chuyên mục';
$lang_module['viewdescription_2'] = 'Hiển thị ở tất cả các trang của chuyên mục';
...
$lang_module['setting_schema_type'] = 'Loại dữ liệu có cấu trúc mặc định khi tạo bài viết';
$lang_module['setting_schema_type_help'] = 'Chọn NewsArticle nếu nội dung là báo điện tử hoặc nội dung là thời sự. Chọn BlogPosting nếu nội dung là bài chia sẻ cá nhân, kinh nghiệm, hoặc nhật ký. Chọn Article nếu không chắc nội dung là blog hay tin tức';
...
$lang_module['content_sourceid_guide'] = 'Điền hoặc nhập để tìm nguồn tin';
...
$lang_module['content_checkcat'] = 'Chuyên mục chính cho bài viết';
$lang_module['content_checkcatmsg'] = 'Bạn cần chọn chuyên mục chính cho bài viết.';
...
$lang_module['msgnocheck'] = 'Bạn cần chọn ít nhất một phần tử';
...
$lang_module['admin_edit_user'] = 'Sửa quyền hạn người dùng';
...
$lang_module['admin_username'] = 'Tên đăng nhập';
...
$lang_module['tags_all_link'] = 'Tất cả tags';
$lang_module['tags_complete_link'] = 'Tags có mô tả';
$lang_module['tags_incomplete_link'] = 'Tags chưa có mô tả';
...
$lang_module['action_not_allowed'] = 'Thao tác của bạn hiện không được phép, vui lòng lưu trữ lại dữ liệu chỉnh sửa hiện tại và quay lại';
$lang_module['setting_copy_news'] = 'Cho phép copy bài viết';
$lang_module['title_copy_news'] = 'Sao chép bài viết';
$lang_module['setting_auto_save'] = 'Cho phép tự động lưu bài viết';
$lang_module['setting_auto_save_help'] = 'Khi bật, bài viết đang soạn thảo sẽ tự động gửi lên máy chủ để lưu lại tránh mất dữ liệu. Tuy nhiên nếu bạn soạn một bài đăng với nội dung rất dài có thể trình duyệt sẽ bị chậm phản hồi';
...
$lang_module['author_uid'] = 'Tài khoản người dùng';
$lang_module['author_select_account'] = 'Hãy chọn tài khoản người dùng';
$lang_module['author_uid_empty'] = 'Vui lòng khai báo tài khoản người dùng';
$lang_module['author_uid_error'] = 'Tài khoản người dùng đã được sử dụng. Vui lòng chọn tài khoản khác';
...
$lang_module['error_tag_tid'] = 'Lỗi: Tag không tồn tại';
$lang_module['error_tag_title'] = 'Vui lòng nhập tiêu đề của tag với tối thiểu 2 ký tự';
$lang_module['error_tag_keywords'] = 'Vui lòng nhập từ khóa của tag với tối thiểu 2 ký tự';
$lang_module['error_tag_keywords_exist'] = 'Từ khóa đã tồn tại. Vui lòng chọn từ khóa khác';
$lang_module['add_multi_tags'] = 'Các tag đã được thêm vào CSDL';
$lang_module['add_multi_tags_empty'] = 'Không có tag nào được thêm vào CSDL';
$lang_module['tag_links'] = 'Liên kết';
$lang_module['keyword'] = 'Từ khóa';
$lang_module['del_all'] = 'Xóa tất cả';
$lang_module['del_selected'] = 'Xóa chọn';
...
$lang_module['notification_report'] = 'Báo cáo lỗi ở bài viết:<br /><strong>%s</strong><br />(Gửi từ IP: <strong>%s</strong>, email: <strong>%s</strong>)';
$lang_module['report'] = 'Báo cáo lỗi';
$lang_module['report_delete'] = 'Xóa và thông báo đến người gửi';
$lang_module['post_ip'] = 'từ IP';
$lang_module['post_time'] = 'Thời gian';
$lang_module['contents'] = 'Nội dung';
$lang_module['article'] = 'Bài viết';
$lang_module['report_del_confirm'] = 'Bạn thực sự muốn xóa?';
$lang_module['report_del_checked'] = 'Xóa các báo cáo đã chọn';
$lang_module['report_empty'] = 'Không có báo cáo lỗi';
$lang_module['report_not_checked'] = 'Vui lòng đánh dấu vào các báo cáo mà bạn muốn xóa';
...
$lang_module['auto_nav'] = 'Tạo mục lục bài viết';
$lang_module['auto_nav0'] = 'Không tạo mục lục bài viết';
$lang_module['auto_nav1'] = 'Tạo mục lục có đánh số tự động';
$lang_module['auto_nav2'] = 'Tạo mục lục có ký hiệu đánh dấu ở đầu mỗi thành phần';
$lang_module['auto_nav3'] = 'Tạo mục lục đơn thuần (không đánh số, không ký hiệu)';
$lang_module['auto_nav_note'] = 'Để tạo mục lục bài viết, bạn cần sử dụng các html-tags h2 và h3 trong phần Nội dung chi tiết. Tag h2 sẽ được chọn là mục chính. Tag h3 phải đặt trong tag h2 và sẽ được chọn là mục con.';
...
$lang_module['tooltip_position_top'] = 'Trên';
$lang_module['tooltip_position_bottom'] = 'Dưới';
$lang_module['tooltip_position_left'] = 'Trái';
$lang_module['tooltip_position_right'] = 'Phải';
$lang_module['tooltip_length'] = 'Số ký tự';
$lang_module['number_day'] = 'Bài đăng trong vòng (ngày qua)';
$lang_module['nocatid'] = 'Không hiển thị trong các chuyên mục';
$lang_module['width'] = 'Chiều rộng hình ảnh';
$lang_module['height'] = 'Chiều cao hình ảnh';
...
$lang_module['admin_topic_sl'] = 'Chọn dòng sự kiện';
$lang_module['admin_topic_slnone'] = 'Không chọn';
$lang_module['admin_topic_manual'] = 'Điền dòng dự kiện';
$lang_module['admin_search_title'] = 'Tiêu đề';
...
$lang_module['localization'] = 'Phiên bản ngôn ngữ khác';
$lang_module['enable_localization'] = 'Khai báo phiên bản ngôn ngữ khác';
$lang_module['select_lang'] = 'Chọn ngôn ngữ';
$lang_module['select_lang_note'] = '- Không khai báo URL của bài viết này. Nó sẽ được tự động thêm vào.<br/>- Phiên bản mặc định là phiên bản được thể hiện khi ngôn ngữ người dùng không có trong danh sách các phiên bản ngôn ngữ được xác định trước.<br/>- Chỉ chấp nhận một URL duy nhất cho một ngôn ngữ';
$lang_module['local_url'] = 'URL đầy đủ đến phiên bản ngôn ngữ';
$lang_module['lang_default'] = 'Mặc định';
$lang_module['all_articles'] = 'Tất cả các bài viết';
$lang_module['draft_not_allowed'] = 'Bạn đã không còn quyền chỉnh sửa bài viết này nữa';
$lang_module['draft_count'] = 'Bạn có %s bài viết đang soạn thảo/chỉnh sửa dở dang';
$lang_module['draft_continue'] = 'Tiếp tục';
$lang_module['draft_list'] = 'Danh sách bài viết đang soạn thảo, chỉnh sửa dở dang';
