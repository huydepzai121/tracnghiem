...
$lang_module['related_articles'] = 'Related articles';
$lang_module['related_sarticles'] = 'Related';
$lang_module['related_articles_ph'] = 'Enter at least 2 characters to search by article name...';
$lang_module['related_articles_p0'] = 'Do not display';
$lang_module['related_articles_p1'] = 'Below the short introduction';
$lang_module['related_articles_p2'] = 'At the end of the article, above the author';
...
$lang_module['search_no_result'] = 'No results match your criteria';
...
$lang_module['from_date_short'] = 'from';
$lang_module['to_date_short'] = 'to';
...
$lang_module['name_empty'] = 'The article has no title';
$lang_module['alias'] = 'Alias';
$lang_module['alias_get'] = 'Generate a alias from the title';
...
$lang_module['setting_schema_type'] = 'Default structured data type when creating articles';
$lang_module['setting_schema_type_help'] = 'Select NewsArticle if the content is news or current events. Select BlogPosting if the content is personal sharing, experiences, or a diary. Select Article if unsure whether the content is a blog or news.';
...
$lang_module['content_sourceid_guide'] = 'Enter or type to find the source';
...
$lang_module['action_not_allowed'] = 'Your action is currently not allowed. Please save the current edited data and try again';
$lang_module['setting_copy_news'] = 'Allowed to copy the article';
$lang_module['title_copy_news'] = 'Copy the article';
$lang_module['setting_auto_save'] = 'Enable auto-save for articles';
$lang_module['setting_auto_save_help'] = 'When enabled, drafts will be automatically sent to the server to prevent data loss. However, if you write a very long article, the browser may become slow to respond';
...
$lang_module['auto_nav_note'] = 'To create an article table of contents, you need to use h2 and h3 html-tags. The h2 tag is the main item, the h3 tag is in the h2 tag and is a sub-item';
...
$lang_module['admin_topic_sl'] = 'Choose a topic';
$lang_module['admin_topic_slnone'] = 'Do not select';
$lang_module['admin_topic_manual'] = 'Enter a new topic';
...
$lang_module['localization'] = 'Other language versions';
$lang_module['enable_localization'] = 'Declare other language versions';
$lang_module['select_lang'] = 'Select language';
$lang_module['select_lang_note'] = '- Do not declare the URL of this article. It will be added automatically.<br/>- The default version is the version shown when the user language is not in the list of predefined language versions.<br/>- Only a single URL per language is accepted';
$lang_module['local_url'] = 'Full URL to language version';
$lang_module['lang_default'] = 'Default';
$lang_module['all_articles'] = 'All articles';
$lang_module['draft_not_allowed'] = 'You no longer have permission to edit this article';
$lang_module['draft_count'] = 'You have %s drafts in progress';
$lang_module['draft_continue'] = 'Continue';
$lang_module['draft_list'] = 'List of drafts in progress';
