...
// Thông tin request
$api_request = [];
$api_request['action'] = $nv_Request->get_title('action', 'get,post', '');
$api_request['module'] = $nv_Request->get_title('module', 'get,post', '');
$api_request['language'] = $nv_Request->get_title(NV_LANG_VARIABLE, 'get,post', '');
