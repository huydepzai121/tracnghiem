...
$lang_module['2step_oauth_add_mail_content'] = '%1$s<br /><br />Administration of the site %2$s would like to inform:<br />Two-step authentication using Oauth in the admin panel has been successfully installed. You can use the account %3$s of the provider %4$s for authentication when you log into the site admin area.';
$lang_module['2step_oauth_del_mail_subject'] = 'Configuring Two-Step Authentication with Oauth has been canceled';
$lang_module['2step_oauth_del_mail_content'] = '%1$s<br /><br />Administration of the site %2$s would like to inform:<br />At your request, 2-Step Verification using Oauth has been successfully canceled. From now on, you cannot use the account %3$s of the provider %4$s to authenticate in the site admin area.';
$lang_module['2step_oauth_dels_mail_content'] = '%1$s<br /><br />Administration of the site %2$s would like to inform:<br />At your request, 2-Step Verification using Oauth has been successfully canceled. From now on, you cannot use the accounts %3$s to authenticate in the site admin area.';
